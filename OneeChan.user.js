...
(function()
{
    var defaultConfig =
    {
        ...
        "Move menu and hide buttons in first thread":  [false, "Moves menu button and hide button in first thread to the right to avoid being overlapped by sidebar elements"], 
    ...
    $SS =
    {
        ...
        DOMLoaded: function(reload)
        {
            ...
            if (reload !== true)
            {
                ...
                if ((div = $(".catalog #settingsWindowLink")).exists()) {
                    var a = $("<span>[<a id='settingsWindowLink' href='javascript:void(0);'>Settings</a>] </span>");
                    $("#ctrl .navLinks").prepend(div);
                    div.replace(a);
                };
